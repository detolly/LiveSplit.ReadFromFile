...
{
    public class ReadFromFileComponent : IComponent
    {
        protected ReadFromFileTextComponent InternalComponent { get; set; }
        ...
        public ReadFromFileComponent(LiveSplitState state)
        {
            Settings = new ReadFileComponentSettings()
            {
                CurrentState = state
            };
            InternalComponent = new ReadFromFileTextComponent(Settings);
        }
